...
| 9 | **Accuracy** | ρ ≈ 1.36 (1.16–1.53, n=11) at ring 1; ring 0 ρ 1.17 (1.13–1.29) — regenerated 2026-09-17, `known-limitations.md` §2b; per-ring RMSE | one sequence's best number |
...
| "ρ = 1.36" | "ρ ≈ 1.36, range 1.16–1.53, n = 11" (was 1.45 / 1.26–1.59 before the 17 Sep regeneration) |
